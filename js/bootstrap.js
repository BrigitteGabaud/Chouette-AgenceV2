    ...
    n(document)
        .on(
            ...
            function (t) {
                ...
                i.call(r, "toggle");
                n(t.target).is('input[type="radio"]') || n(t.target).is(
                    'input[type="checkbox"]'
                ) || t.preventDefault()
            }
        )
...
+function (n) {
    ...
    var t = function (t, i) {
            ...
            this.options.keyboard && this
                .$element
                .on("keydown.bs.carousel", n.proxy(this.keydown, this));
    ...
    t.prototype.pause = function (t) {
        ...
        this
            .$element
            .find(".next, .prev")
            .length && n.support.transition && (
                this.$element.trigger(n.support.transition.end),
                this.cycle(!0)
            ),
        this.interval = clearInterval(this.interval),
        this
    ...
    r = function (t) {
        var o,
            r = n(this),
            u = n(
                r.attr("data-target") || (o = r.attr("href")) && o.replace(/.*(?=#[^\s]+$)/, "")
            ),
            e,
            f;
        u.hasClass("carousel") && (
...
+function (n) {
    ...
    function r(t) {
        var i,
            r = t.attr("data-target") || (i = t.attr("href")) && i.replace(
                /.*(?=#[^\s]+$)/,
                ""
            );
        return n(r)
    ...
    var t = function (i, r) {
            ...
            this.options = n.extend({}, t.DEFAULTS, r);
            this.$trigger = n(
                '[data-toggle="collapse"][href="#' + i.id + '"],[data-toggle="collapse"][data-t' +
                'arget="#' + i.id + '"]'
            );
    ...
    t.prototype.show = function () {
        ...
        if (!this.transitioning && !this.$element.hasClass("in") && (
            ...
            if (
                ...
                u = this.dimension(),
                this.$element.removeClass("collapse").addClass("collapsing")[u](
                    0
            ...
            this
                ...
                .emulateTransitionEnd(t.TRANSITION_DURATION)[u](this.$element[0][s])
        }
    };
...
+function (n) {
    ...
    function u(t) {
        t && 3 === t.which || (n(o).remove(), n(i).each(function () {
            ...
            i.hasClass("open") && (
                t && "click" == t.type && /input|textarea/i.test(t.target.tagName) && n.contains(i[0], t.target) || (i.trigger(t = n.Event("hide.bs.dropdown", f)), t.isDefaultPrevented() || (
...
+function (n) {
    ...
    var t = function (t, i) {
            ...
            this.options.remote && this
                .$element
                .find(".modal-content")
                .load(this.options.remote, n.proxy(function () {
                    this
                        .$element
    ...
    t.prototype.hide = function (i) {
        ...
        this.isShown && !i.isDefaultPrevented() && (
            ...
            n.support.transition && this.$element.hasClass("fade")
                ? this.$element.one("bsTransitionEnd", n.proxy(this.hideModal, this)).emulateTransitionEnd(
    ...
    t.prototype.enforceFocus = function () {
        n(document)
            ...
            .on("focusin.bs.modal", n.proxy(function (n) {
                this.$element[0] === n.target || this
                    .$element
                    .has(n.target)
                    .length || this
                    .$element
    ...
    t.prototype.escape = function () {
        this.isShown && this.options.keyboard
            ? this
                .$element
                .on("keydown.dismiss.bs.modal", n.proxy(function (n) {
    ...
    t.prototype.backdrop = function (i) {
        ...
        if (this.isShown && this.options.backdrop) {
            if (
                ...
                this.$backdrop = n(document.createElement("div")).addClass(
                    "modal-backdrop " + f
                ).appendTo(this.$body),
            ...
            !this.isShown && this.$backdrop
                ? (
                    ...
                    n.support.transition && this.$element.hasClass("fade")
                        ? this.$backdrop.one("bsTransitionEnd", u).emulateTransitionEnd(
    ...
    t.prototype.adjustDialog = function () {
        ...
        this
            .$element
            .css({
                paddingLeft: !this.bodyIsOverflowing && n
                    ? this.scrollbarWidth
                    : "",
                paddingRight: this.bodyIsOverflowing && !n
                    ? this.scrollbarWidth
                    : ""
            })
    };
    ...
    t.prototype.setScrollbar = function () {
        ...
        this.bodyIsOverflowing && this
            .$body
            .css("padding-right", n + this.scrollbarWidth)
    };
...
+function (n) {
    ...
    t.DEFAULTS = {
        ...
        placement: "top",
        selector: !1,
        template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"><\/div><div cla' +
                'ss="tooltip-inner"><\/div><\/div>',
        trigger: "hover focus",
        title: "",
        delay: 0,
        html: !1,
    ...
    t.prototype.init = function (t, i, r) {
        ...
        if (
            ...
            this.$viewport = this.options.viewport && n(
        ...
        for (f = this.options.trigger.split(" "), e = f.length; e--;) 
            if (u = f[e], "click" == u) 
                this
                    .$element
                    .on("click." + this.type, this.options.selector, n.proxy(this.toggle, this));
            else 
                "manual" != u && (
                    o = "hover" == u
                        ? "mouseenter"
    ...
    t.prototype.enter = function (t) {
        ...
        return i || (
            ...
            n(t.currentTarget).data(
                "bs." + this.type,
                i
            )
        ),
        t instanceof n.Event && (i.inState[
            "focusin" == t.type
                ? "focus"
                : "hover"
        ] = !0),
    ...
    t.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            y && (
                ...
                i = "bottom" == i && f.bottom + s > e.bottom
                    ? "top"
                    : "top" == i && f.top - s < e.top
                        ? "bottom"
            ...
            h = function () {
                ...
                u
                    .$element
                    .trigger("shown.bs." + u.type);
                u.hoverState = null;
                "out" == n && u.leave(u)
            };
            n.support.transition && this
                .$tip
                .hasClass("fade")
                    ? r
    ...
    t.prototype.fixTitle = function () {
        var n = this.$element;
        (n.attr("title") || "string" != typeof n.attr("data-original-title")) && n
            .attr(
                "data-original-title",
                n.attr("title") || ""
            )
    ...
    t.prototype.toggle = function (t) {
        var i = this;
        t && (i = n(t.currentTarget).data("bs." + this.type), i || (
            i = new this.constructor(t.currentTarget, this.getDelegateOptions()),
            n(t.currentTarget).data(
                "bs." + this.type,
                i
...
+function (n) {
    ...
    t.DEFAULTS = n.extend({}, n.fn.tooltip.Constructor.DEFAULTS, {
        ...
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="arrow"><\/div><h3 class="popov' +
                'er-title"><\/h3><div class="popover-content"><\/div><\/div>'
    });
...
+function (n) {
    ...
    function t(i, r) {
        ...
        this
            .$scrollElement
            .on("scroll.bs.scrollspy", n.proxy(this.process, this));
        this.refresh();
        this.process()
    }
    function i(i) {
    ...
    t.prototype.process = function () {
        ...
        if (u && i < t[0]) 
            ...
            this.clear();
        for (n = t.length; n--;) 
            u != r[n] && i >= t[n] && (void 0 === t[n + 1] || i < t[n + 1]) && this.activate(
                r[n]
            )
    };
    t.prototype.activate = function (t) {
        this.activeTarget = t;
        this.clear();
        var r = this.selector + '[data-target="' + t + '"],' + this.selector +
                    '[href="' + t + '"]',
            i = n(r)
                .parents("li")
                .addClass("active");
    ...
    var t = function (i, r) {
            ...
            this.$target = n(this.options.target)
                .on(
                    ...
                    n.proxy(this.checkPosition, this)
                )
    ...
    t.prototype.checkPosition = function () {
        ...
        if (this.$element.is(":visible")) {
            ...
            if (
                ...
                if (null != this.unpin && this.$element.css("top", ""), e = "affix" + (
                    i
                        ? "-" + i
                        : ""
                ), o = n.Event(e + ".bs.affix"), this.$element.trigger(o), o.isDefaultPrevented()) 
                    return;
                this.affixed = i;
                this.unpin = "bottom" == i
