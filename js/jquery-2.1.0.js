...
function (a, b) {
        ...
        o.extend({
            ...
            when: function (a) {
                var b = 0,
                    c = d.call(arguments),
                    e = c.length,
                    f = 1 !== e || a && o.isFunction(a.promise)
                        ? e
                        : 0,
                    g = 1 === f
                        ? a
        ...
        o.event = {
            ...
            trigger: function (b, c, d, e) {
                ...
                if (
                    g = h = d = d || m,
                    3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + o.event.triggered) && (
                    ...
                    while ((g = p[f++]) && !b.isPropagationStopped()) 
                        ...
                        l && l.apply(g, c),
                        l = k && g[k],
                        l && l.apply && o.acceptData(g) && (
                            b.result = l.apply(g, c),
                            b.result === !1 && b.preventDefault()
                        );
                    return b.type = q,
                    e || b.isDefaultPrevented() || n._default && n
                        ._default
                        .apply(p.pop(), c) !== !1 || !o.acceptData(d) || k && o.isFunction(d[q]) && !o.isWindow(
                            d
                        ) && (
                        h = d[k],
                        h && (d[k] = null),
                ...
                ? (
                    a && a.type
                        ? (
                            ...
                            this.type = a.type,
                            this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.getPreventDefault && a.getPreventDefault()
                                ? Z
                                : $
                        )
                        : this.type = a,
        ...
        l.focusinBubbles || o.each({
            ...
            var c = function (a) {
                o
                    .event
                    .simulate(b, a.target, o.event.fix(a), !0)
            };
            o
                .event
                .special[b] = {
        ...
        ib.th = ib.td;
        function jb(a, b) {
            return o.nodeName(a, "table") && o.nodeName(
                11 !== b.nodeType
                    ? b
                    : b.firstChild,
                "tr"
                    ...
                    if (k && (
                        ...
                        if (g) 
                            for (i = f[f.length - 1].ownerDocument, o.map(f, lb), j = 0; g > j; j++) 
                                h = f[j],
                                fb.test(h.type || "") && !L.access(h, "globalEval") && o.contains(i, h) && (
                                    h.src
        ...
        !function () {
            var b,
                c,
                d = "padding:0;margin:0;border:0;display:block;-webkit-box-sizing:content-box;-moz-" +
            ...
            f.appendChild(g);
            function h() {
                g.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box" +
            ...
            attr: function (a, b, c) {
                ...
                if (a && 3 !== f && 8 !== f && 2 !== f) 
                    return typeof a.getAttribute === U
                        ? o.prop(a, b, c)
                        : (
                            1 === f && o.isXMLDoc(a) || (b = b.toLowerCase(), d = o.attrHooks[b] || (
                                o.expr.match.bool.test(b)
                                    ? Zb
                                    : Yb
                            )),
                            void 0 === c
        ...
        o
            ...
            .extend({
                ...
                o.fn.extend({
                    val: function (a) {
                            ...
                            e = this[0];
                        {
                                ...
                                this.each(function (c) {
                                    ...
                                    1 === this.nodeType && (
                                        ...
                                        null == e
                                            ...
                                            : "number" == typeof e
                                                ? e += ""
                                                : o.isArray(e) && (e = o.map(e, function (a) {
                                                    return null == a
                                                        ? ""
                                                        : a + ""
                                                })),
                                        b = o.valHooks[this.type] || o.valHooks[
                                            this
                                                .nodeName
                                                .toLowerCase()
                                        ],
                            ...
                            if (e) 
                                return b = o.valHooks[e.type] || o.valHooks[
                                    e
                                        .nodeName
                                        .toLowerCase()
                                ],
                ...
                o.parseJSON = function (a) {
                    ...
                    return (!b || b.getElementsByTagName("parsererror").length) && o.error(
                        "Invalid XML: " + a
                    ),
                    b
                };
                    ...
                    ajax: function (a, b) {
                        ...
                        if (
                            ...
                            null == k.crossDomain && (
                                ...
                                k.crossDomain = !(!h || h[1] === ec[1] && h[2] === ec[2] && (h[3] || (
                                    "http:" === h[1]
                                        ? "80"
                                        : "443"
                                )) === (ec[3] || (
                ...
                o.offset = {
                    ...
                    return this.length
                }, o.fn.andSelf = o.fn.addBack, "function" == typeof define && define.amd && define(
                    "jquery",
                    [],
                    function () {
                        return o
